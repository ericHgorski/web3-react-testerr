...
function createWebAuthnNotSupportError() {
    return new MagicSDKError(types_1.SDKErrorCode.WebAuthnNotSupported, 'WebAuthn is not supported in this device.');
}
exports.createWebAuthnNotSupportError = createWebAuthnNotSupportError;
function createWebAuthCreateCredentialError(message) {
    return new MagicSDKError(types_1.SDKErrorCode.WebAuthnCreateCredentialError, "Error creating credential: " + message);
}
